...
@Composable
private fun Home(state:NovaState, update:(NovaState)->Unit, onGo:(Screen)->Unit) {
    val context = LocalContext.current
...
@Composable
private fun Missions(state:NovaState, update:(NovaState)->Unit) {
...
@Composable
private fun Business(state:NovaState, update:(NovaState)->Unit) {
    var dialog by remember { mutableStateOf(false) }
...
@Composable
private fun WatchLab(state:NovaState, update:(NovaState)->Unit) {
    var dialog by remember { mutableStateOf(false) }
...
@Composable
private fun Money(state:NovaState, update:(NovaState)->Unit) {
    var dialog by remember { mutableStateOf(false) }
...
@Composable
private fun Brain(state:NovaState, update:(NovaState)->Unit) {
...
@Composable
private fun Settings(state:NovaState, update:(NovaState)->Unit) {
